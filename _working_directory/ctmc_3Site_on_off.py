...
for run in range(0,1):
    ...
    for site in range(0, numberOfSites):
        ...
        walkRecord, currentState, step, cumulative_walking_time = random_walk(concentration=0, step=step, timepoint=samplingInterval, walkRecord=walkRecord, cumulative_walking_time=cumulative_walking_time, currentState=currentState)
